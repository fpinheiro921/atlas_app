...
export const KB_ENERGY_BALANCE = `# Principle 1: Energy Balance is the Primary Driver of Weight Change
...
export const KB_METABOLIC_ADAPTATION = `# Principle 2: Metabolic Adaptation is a Natural Response to Dieting
...
export const KB_NUTRITION = `# Principle 3: A Protein-Focused, Flexible Approach to Macronutrients

While total calories determine weight loss, the macronutrient composition of those calories is crucial for optimizing body composition (losing fat while retaining muscle).
...
- **Thermic Effect (TEF):** Protein has the highest TEF, meaning your body burns more calories digesting it compared to carbs and fats.

**Protein targets should be based on Lean Body Mass (LBM), not total body weight**, especially for individuals with higher body fat percentages. Targets should also increase with age and during a caloric deficit to combat catabolism. A general evidence-based range is **1.8 - 3.1 g/kg of LBM**.

## Carbohydrates and Fats: The Energy Levers

Once protein is set, the remaining calories should be allocated to carbohydrates and fats based on personal preference and sustainability.
- **Interchangeability:** For fat loss, carbs and fats are largely interchangeable when calories and protein are equated. Low-fat diets may have a very slight metabolic advantage, but this is easily overridden by adherence.
- **Performance:** Carbohydrates are the primary fuel for high-intensity exercise.
- **Hormones:** Dietary fat is essential for producing hormones like testosterone. Fat intake should generally not fall below 20-25% of total calories.
- **Adherence is Key:** The best split of carbs and fats is the one you can stick to consistently. A balanced approach (e.g., 50/50, 60/40) is often a good starting point.

## Fiber: The Unsung Hero

Fiber is crucial for satiety, gut health, and mitigating some of the caloric impact of food.
- **Target:** Aim for **10-15 grams of fiber per 1000 calories** consumed. This helps increase food volume and promote fullness, which is essential during a caloric deficit.`;

export const KB_FAT_LOSS = `# Principle 4: Implement a Slow, Sustainable, and Strategic Fat Loss Phase
...
- **Recommended Target:** Aim to lose **0.4% to 0.8%** of your total body weight per week.
- **Maximum Rate:** A rate of 1.0% per week should be considered the absolute maximum, typically reserved for individuals with a higher starting body fat percentage.

Faster rates of loss significantly increase the risk of muscle loss, which in turn leads to a greater decrease in metabolic rate and a higher chance of weight regain.

## Diet Breaks: A Strategic Tool
...
- **Purpose:**
    ...
    - **Hormonal Reset:** Can help normalize leptin and ghrelin levels, reducing hunger and making the subsequent deficit easier to manage.
    - **Psychological Reset:** Provides a mental break from the grind of a deficit, boosting adherence and preventing burnout.
- **Implementation:** For longer fat loss phases, consider implementing a 1-week diet break for every 8-12 weeks spent in a deficit.

## Refeeds / High-Calorie Days

A refeed is a shorter, 1-2 day period of increased calories, typically from carbohydrates, within a diet week.
- **Psychological Benefit:** Can improve adherence by allowing for more food flexibility and social eating.
- **Physiological Benefit:** Causes a transient increase in leptin and metabolic rate. While this effect is short-lived and unlikely to significantly boost overall fat loss, it can make the dieting process more tolerable.
- **Key:** The total weekly caloric deficit must be maintained for progress to continue. High-calorie days must be balanced by lower-calorie days.

## Transitioning from Reverse Dieting to Fat Loss

After a successful reverse diet, your TDEE is elevated and you are in a prime position to start a new fat loss phase. However, how you transition is critical.

- **Avoid Slow Tapering:** Do not slowly decrease calories. Your body's metabolic adaptation works in both directions. A slow reduction in calories will likely be met with a proportional decrease in your metabolic rate, leading to a frustrating plateau before you even start.
- **Make a Decisive Drop:** To effectively start losing fat, you must create a significant enough energy deficit to push you out of your "maintenance calorie range." A starting reduction of **~20% from your final reverse diet calorie level** is recommended. This ensures you create a meaningful deficit to initiate fat loss.
- **Maintain Activity:** It is crucial to maintain your step count and training performance as you enter the new deficit. A drop in NEAT is a primary way the body adapts, so consciously keeping activity levels high is key to making the deficit effective.`;

export const KB_REVERSE_DIETING = `# Principle 5: Master the "Diet After the Diet" with Reverse Dieting
...
export const KB_TRAINING = `# Principle 6: Train for Muscle Retention and Adjust Cardio Strategically
...
- **Structure:** These workouts are typically performed "for time" (completing a set amount of work as fast as possible) or as AMRAPs ("as many rounds/reps as possible" in a given time). Common structures include descending ladders (e.g., 50-40-30-20-10 reps) or circuits of multiple exercises for a set number of rounds.
- **Benefit:** This style of training is highly efficient at improving overall fitness and can be a sustainable way to increase energy expenditure. A well-rounded bodyweight plan should alternate between strength-focused days and MetCon days.
...
export const KB_BEHAVIORAL = `# Principle 7: Cultivate the Behaviors of Long-Term Success

The best diet plan in the world is useless if you cannot adhere to it. The "5%" of people who successfully keep weight off have mastered specific behaviors and mindsets.

## Adherence and Sustainability are Paramount

The most important factor for any nutritional strategy is your ability to sustain it long-term. This means the plan must fit **your** lifestyle and preferences. There is no one-size-fits-all "best diet."

## Key Behaviors

1.  **Cognitive Restraint (Flexible Control):**
    Successful dieters practice some form of restraint, but flexibly. They avoid a "black and white" or "all or nothing" mindset. No foods are "good" or "bad"; they are simply tools to be managed within a caloric and macronutrient budget. This prevents the "disinhibition reflex" where one "bad" food choice leads to a full-blown binge.

2.  **Self-Monitoring:**
    This is the habit of being aware of your intake and progress.
    - **Weighing In:** Weighing in daily and taking the weekly average is the most accurate way to track progress and smooth out daily fluctuations.
    - **Tracking Intake:** Whether it's counting macros, taking photos of meals, or another method, tracking provides objective data and holds you accountable.
    - **Circumference Measurements:** Waist and hip measurements can reveal body composition changes even when the scale isn't moving.

3.  **Structured Flexibility:**
    Plan your meals and activity, but build in flexibility. Have a plan for social events. If you go over your calories one day, don't panic. Simply get back on track with your next meal. Don't try to "make up" for it with excessive restriction, as this often leads to a binge-restrict cycle.

4.  **Focus on the Long-Term:**
    Successful individuals have low "recency bias." They don't sacrifice their long-term goal for short-term gratification. They understand that consistency over months and years, not perfection over days, is what drives results.`;

export const KB_GOURMET_NUTRITION_RECIPES = `Gourmet Nutrition Recipes
Breakfast
...
This version of stuffed squash is delicious, very healthy, and it's even nice to look at. A generous heaping of chicken and vegetables complements the distinctive flavor of butternut squash, which is really brought to life with the addition of grated orange peel.
INGREDIENTS
...
Salt & pepper, to taste
INSTRUCTIONS
To make the marinara sauce, chop the tomatoes and place them in a nonstick pan over medium-low heat. Mix in 4 cloves chopped garlic & 1 chopped onion, and sliced green pepper. Stew with a lid after stirring in a dash of salt, some oregano & basil.
...
PRELUDE
As long as you are using extra lean ground beef (96% lean), the addition of a peanut sauce and chili powder provides a powerful taste combination that compliments the bold flavor of beef. Cabbage adds a nice textural component, and the green peppers complete the meal.
INGREDIENTS
...
PRELUDE
This foolproof recipe combines the harmony of red meat and wine, together with a chemistry of various herbs, spices, and vegetables that is sure to please. The long cooking time ensures tender, juicy chunks of meat.
INGREDIENTS
...
For the first half of the cooking period, leave the tomatoes out of the equation. Coat the kabobs with olive oil and cook about 4 inches from the heat for 5 minutes. Remove the skewers, put the cherry tomatoes on the ends, then return to the oven or grill on the other side for another 5 minutes, or just until the meat is cooked through.
Soups & Stews
Dr. John’s Chili (PW)
PRELUDE
...
In a large skillet or wok, brown the cubed steak and minced garlic in half of the olive oil, just until the outside is brown (leaving the inside raw). When the beef is browned, add the water and bouillon cube to the skillet. Bring to a boil, then pour mixture into the Crock Pot
...
export const KB_LAYNE_NORTON_TRAINING_SPLITS = `# Principle 8: Sample Training Splits
...
export const KB_EXERCISE_LIBRARY = `# Atlas Exercise Library
...
- **Pull-ups:** (Requires pull-up bar) Hang from a bar with an overhand grip. Pull your chest up to the bar.
...
- **Dips (using chair or bench):** Place your hands on the edge of a chair behind you. Extend your legs out. Lower your body by bending your elbows, then press back up.
